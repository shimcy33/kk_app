class AssetConstants {
  ...
  static const String loginDotPattern = "assets/icons/login_dot_pattern.svg";
...
class StringConstants {
  ...
  static String birthdays = "Birthdays?";
  static String weLoveThem = "We love them!".toUpperCase();
  static String joinReward =
      "Join Rewards and enjoy an exclusive well-deserved birthday treat on us!";
